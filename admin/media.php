...
<head>
  ...
  <title>E-Learning | E-Learning smk tamansiswa</title>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="logo">
            ...
            <p class="meta" style="margin-left: 4%;">smk tamansiswa jetis</p>
          </div>
        </div>
        <div class="col-md-4">
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="<?php if ($_GET[module] == 'profil') {echo "open";} ?>"><a href="media.php?module=profil"><i class="fa fa-user"></i> Administrator</a></li>

          <!-- <li class="<?php if ($_GET[module] == 'ta') {echo "open";} ?>"><a href="media.php?module=ta"><i class="fa fa-calendar"></i> Tahun Ajaran</a></li>   -->
         
          <!-- <li class="<?php if ($_GET[module] == 'kelas') {echo "open";} ?>"><a href="media.php?module=kelas"><i class="fa fa-group"></i> Kelas</a></li> -->

          <li class="has_sub <?php if ($_GET[module] == 'admin' || $_GET[module] == 'guru' || $_GET[module] == 'siswa') { echo "open";} ?>">
			         <a href="#"><i class="fa fa-users"></i> User  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <li class="<?php if ($_GET[module] == 'admin'){ echo "current"; }?>"><a href="media.php?module=admin">Admin</a></li>
              <li class="<?php if ($_GET[module] == 'guru'){ echo "current"; }?>"><a href="media.php?module=guru">Guru</a></li>
              <li class="<?php if ($_GET[module] == 'siswa'){ echo "current"; }?>"><a href="media.php?module=siswa">Siswa</a></li>
            </ul>
          </li>

          <li class="has_sub <?php if ($_GET[module] == 'kelas' || $_GET[module] == 'mapel') { echo "open";} ?>">
               <a href="#"><i class="fa fa-mortar-board"></i> Akademik  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <li class="<?php if ($_GET[module] == 'kelas'){ echo "current"; }?>"><a href="media.php?module=kelas">Kelas</a></li>
              <li class="<?php if ($_GET[module] == 'mapel'){ echo "current"; }?>"><a href="media.php?module=mapel">Pelajaran</a></li>
            </ul>
          </li>

            <!-- <li class="has_sub <?php if ($_GET[module] == 'mapel' || $_GET[module] == 'detail_mapel' ) { echo "open";} ?>">
               <a href="#"><i class="fa fa-file-text"></i> Mata Pelajaran  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <li class="<?php if ($_GET[module] == 'mapel'){ echo "current"; }?>"><a href="media.php?module=mapel">Mata Pelajaran</a></li>
              <li class="<?php if ($_GET[module] == 'detail_mapel'){ echo "current"; }?>"><a href="media.php?module=detail_mapel">Detail Mata Pelajaran</a></li>
            </ul>
          </li>		 -->
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
            <p class="copy">Copyright &copy; 2018 | <a href="media.php?module=home">MTs Nurul Ali</a> | Developer By <a href="https://www.instagram.com/adibsugandi/?hl=id" target="_blank">Akbar Rizqy Taufiqy</a></p>
      </div>
    </div>
  </div>
</footer> 	
