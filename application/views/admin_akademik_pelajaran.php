  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Informasi Pelajaran</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo base_url() ?>admin/form-add-pelajaran" class="btn btn-default float-right add-new"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <td>
                          <div class='btn-group'>
                            ...
                            <div class='dropdown-menu' role='menu' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(67px, -165px, 0px);'>
                              <a class='dropdown-item edit' href='".base_url('admin/edit-pelajaran/'.$value->pelajaran_id)."'>Edit</a>
                              <a class='dropdown-item delete' href='".base_url('admin/delete-pelajaran/'.$value->pelajaran_id)."'>Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
...
<script>
  ...
  $(document).on('submit', 'form#addNewPelajaran', function(e) {
    e.preventDefault();    
    ...
    $.ajax({
        ...
        success: function (data) {
            alert( (data.stats=='1') ? 'Data Berhasil Disimpan' : 'Data Gagal Disimpan' )
            location.reload()
        },
        cache: false,
        contentType: false,
  ...
  $(document).on('submit','form#editPelajaran',function(e){
    e.preventDefault();    
    var formData = new FormData(this);
