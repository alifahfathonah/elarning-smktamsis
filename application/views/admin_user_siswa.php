        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo base_url() ?>admin/form-add-data-siswa" class="btn btn-default float-right add-new"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  foreach ($siswa as $key => $value) {
                    echo "
                      <tr>
                        ...
                        <td>{$value->siswa_username}</td>
                        <td>{$value->siswa_password}</td>
                        <td>
                          <div class='btn-group'>
                            ...
                            <div class='dropdown-menu' role='menu' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(67px, -165px, 0px);'>
                              <a class='dropdown-item edit' href='".base_url('admin/form-edit-data-siswa/'.$value->siswa_id)."'>Edit</a>
                              <a class='dropdown-item delete' href='".base_url('admin/delete-data-siswa/'.$value->siswa_id)."'>Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
