...
<head>
  ...
  <title>E-Learning | smk tamansiswa jetis</title>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="<?php if ($_GET[module] == 'materi' || $_GET[module] == 'soal') {echo "open";} ?>"><a href="media.php?module=materi"><i class="fa fa-file-text"></i> Materi</a></li>
          ...
          <li class="has_sub <?php if ($_GET[module] == 'jadwal' || $_GET[module] == 'jadwalujian') { echo "open";} ?>">
               <a href="#"><i class="fa fa-calendar"></i> Jadwal Ujian <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            
            <ul>  
            <li class="<?php if ($_GET[module] == 'jadwal' ){ echo "current"; }?>"><a href="media.php?module=jadwal"> Soal</a>
            </li>

            <li class="<?php if ($_GET[module] == 'jadwalujian' ){ echo "current"; }?>"><a href="media.php?module=jadwalujian"> Soal Tugas</a>
            </li>
            </ul>
          ...
          <li class="has_sub <?php if ($_GET[module] == 'tugas' || $_GET[module] == 'jawaban') { echo "open";} ?>">
               <a href="#"><i class="fa fa-file-text"></i> Tugas <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            
            <ul>
            <li class="<?php if ($_GET[module] == 'tugas' ){ echo "current"; }?>"><a href="media.php?module=tugas"> Upload Soal Tugas</a>
            </li>
            <li class="<?php if ($_GET[module] == 'jawaban' ){ echo "current"; }?>"><a href="media.php?module=jawaban"> Download Tugas Siswa</a>
            </li>
            </ul>

          </li>
            <li class="<?php if ($_GET[module] == 'kumpul') { echo "open"; }?>"><a href="media.php?module=kumpul"><i class="fa fa-file"></i> Siswa Belum Upload</a></li>
<!-- 
          <?php } ?>
          ...
          <li class="<?php if ($_GET[module] == 'belum') {echo "open";} ?>"><a href="media.php?module=belum"><i class="fa fa-file-text"></i> Siswa Belum Ujian</a></li>

          <li class="has_sub <?php if ($_GET[module] == 'nilai') { echo "open";} ?>">
               <a href="#"><i class="fa fa-file-text"></i> Nilai Hasil Ujian <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <?php 
                $id_guru = $_SESSION['id_guru'];
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-12">
            <p class="copy">Copyright &copy; 2018 | <a href="media.php?module=home">smk tamansiswa jetis</a> | Developer By <a href="" target="_blank">Akbar Rizqy Taufiqy</a></p>
      </div>
    </div>
  </div>
</footer> 	
